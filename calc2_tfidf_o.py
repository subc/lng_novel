...
def main():
    ...
    # 重複排除して出力
    un_overlap = []
    tfidf_night_of_milky_way_train_dict = {k: v for k, v in tfidf_night_of_milky_way_train}
    for key, value in sorted_result:
        if key not in tfidf_night_of_milky_way_train_dict.keys():
            print "特徴名詞: {}:{}".format(key, value)
